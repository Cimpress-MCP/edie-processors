...
<mj-section ><mj-column ><mj-button width="200px" border="0px solid #127769">ACCEPT</mj-button>
<mj-image src="path_to_horse" href="horse_website" alt="Image of a horse" width="100%" border="0px solid #4f5d75"/>
</mj-column>
<mj-column ><mj-button width="200px" border="2px solid #a9d6e5">REJECT</mj-button>
</mj-column>
<mj-column ><mj-button width="200px" border="0px solid #4f5d75">ORDER SHIPPED</mj-button>
</mj-column>
</mj-section>
...
<mj-column width="34%"><mj-button width="200px">STOCK</mj-button>
<mj-button width="200px">DELIVERY</mj-button>
<mj-button width="200px">ARTWORK</mj-button>
<mj-button width="200px">QUALITY</mj-button>
</mj-column>
